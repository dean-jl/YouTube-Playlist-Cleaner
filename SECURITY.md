...
Instead, click [New Issue](https://github.com/dean-jl/YouTube-Playlist-Cleaner/issues/new), then select **🔐 Security Report** from the list of templates.

If you're unsure whether to disclose publicly, start a thread in [Discussions → Security](https://github.com/dean-jl/YouTube-Playlist-Cleaner/discussions/categories/security).
